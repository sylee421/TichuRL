...
def get_legal_combination(combinations, ground):
    ...
    if ground.type == 'none':
        rt_set = combinations[0] + combinations[1] + combinations[2] + combinations[3] + combinations[4] + combinations[5]
        ...
        rt_set = rt_set + combinations[0] + combinations[3]
        ...
        rt_set = rt_set + combinations[1] + combinations[3]
        ...
        rt_set = rt_set + combinations[2] + combinations[3]
        ...
        rt_set = rt_set + combinations[4] + combinations[3]
        ...
        rt_set = rt_set + combinations[5] + combinations[3]
    else:
