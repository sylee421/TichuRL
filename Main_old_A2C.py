...
os.environ['CUDA_VISIBLE_DEVICES'] = '1' # 선택한 gpu에만 메모리 할당
...
# from agents.double_DQN import Agent_2DQN
# from agents.double_DQN_mix import Agent_2DQN
# from agents.double_DQN2 import Agent_2DQN
# from agents.double_DQN4 import Agent_2DQN
# from agents.double_DQN5 import Agent_2DQN
from agents.A2C2 import Agent_A2C
...
with tf.Session(config=config) as sess:
    ...
    agent_1 = Random()
    agent_2 = Random()
    agent_3 = Agent_A2C(sess, is_training=True)
    ...
    # agent_1 = Random()
    # agent_2 = Random()
    # agent_3 = Agent_A2C(sess, is_training=False)
    # env.set_agents([agent_0, agent_1, agent_2, agent_3])
    # env.verbose = 0
    # env.human = 0        
    # agent_3.load()
